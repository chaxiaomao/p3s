...
class ProductCommitNote extends \common\models\c2\entity\ProductionCommitNote
{
    ...
    public function setStateToCommit()
    {
        ...
        if (!empty($items)) {
            foreach ($items as $item) {
                // $productionCombination = ProductCombination::findOne($item['combination_id']);
                $comb = $item->productCombination;
                $comb->stock += $item->commit_sum;
                $comb->save();
