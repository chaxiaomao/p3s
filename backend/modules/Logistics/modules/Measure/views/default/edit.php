...
use backend\modules\Logistics\modules\Measure\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\Measure */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Measure'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Measures'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Measure'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Measures'), 'url' => ['index']];
