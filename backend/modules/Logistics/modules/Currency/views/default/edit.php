...
use backend\modules\Logistics\modules\Currency\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\Currency */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Currency'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Currencies'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Currency'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Currencies'), 'url' => ['index']];
