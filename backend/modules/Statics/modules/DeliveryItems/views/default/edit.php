...
use backend\modules\Statics\modules\DeliveryItems\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\InventoryDeliveryNoteItem */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Inventory Delivery Note Item'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Delivery Note Items'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Inventory Delivery Note Item'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Delivery Note Items'), 'url' => ['index']];
