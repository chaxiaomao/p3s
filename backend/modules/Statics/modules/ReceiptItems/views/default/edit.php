...
use backend\modules\Statics\modules\ReceiptItems\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\InventoryReceiptNoteItem */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Inventory Receipt Note Item'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Receipt Note Items'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Inventory Receipt Note Item'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Receipt Note Items'), 'url' => ['index']];
