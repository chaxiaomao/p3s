...
$form = ActiveForm::begin([
    'action' => ['back-mixture', 'id' => $model->entityModel->id],
    'options' => [
...
?>
    ...
    <div class="<?= $model->getPrefixName('form') ?>">
        ...
        <p style="color: red;">提示：请输入返仓数量，保存成功后即时回仓物料库存，请勿重复提交！</p>
        <?php
        ...
        <div class="well">
            ...
            echo Form::widget([
                ...
                'attributes' => [
                    'number' => [
                        'label' => Yii::t('app.c2', 'Back Number'),
                        'type' => Form::INPUT_TEXT,
                        'options' => [
                            'placeholder' => Yii::t('app.c2', 'Back Number')
                        ]
                    ],
                ]
            ]);
