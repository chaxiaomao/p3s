        ...
        <?php echo GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'template' => '{update} {commit} {sab} {enter} {termination} {finish} {delete}',
                    'width' => '200px',
                    'visibleButtons' => [
                    ...
                    'buttons' => [
                        ...
                        'enter' => function ($url, $model, $key) {
                            return Html::a(Yii::t('app.c2', 'Process Enter'), [
                                '/p3s/warehouse-note/process-receipt',
                                'id' => $model->id
                            ], [
                                'title' => Yii::t('app.c2', 'Process Enter'),
                                'data-pjax' => '0',
