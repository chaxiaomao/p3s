...
use backend\modules\PAM\modules\ProductionCommitNote\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\ProductionCommitNote */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Production Commit Note'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Production Commit Notes'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Production Commit Note'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Production Commit Notes'), 'url' => ['index']];
