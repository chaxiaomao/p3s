...
use backend\modules\Database\modules\Product\modules\Package\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\ProductPackage */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Product Package'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Product Packages'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Product Package'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Product Packages'), 'url' => ['index']];
