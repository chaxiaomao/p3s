...
use backend\modules\Database\modules\Warehouse\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\Warehouse */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Warehouse'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouses'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Warehouse'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouses'), 'url' => ['index']];
