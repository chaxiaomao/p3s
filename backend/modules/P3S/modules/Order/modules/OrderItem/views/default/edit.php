...
use backend\modules\P3S\modules\Order\modules\OrderItem\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\OrderItem */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Order Item'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Order Items'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Order Item'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Order Items'), 'url' => ['index']];
