    ...
    <div class="well">
        ...
        echo Form::widget([
            ...
            'attributes' => [
                ...
                // 'supplier_id' => [
                //     'type' => Form::INPUT_DROPDOWN_LIST,
                //     'items' => \common\models\c2\entity\Supplier::getHashMap('id', 'name', ['status' => EntityModelStatus::STATUS_ACTIVE]),
                //     'options' => [
                //         'placeholder' => $model->getAttributeLabel('warehouse_id')
                //     ]
                // ],
                'supplier_id' => [
                    ...
                    //     ]),
                    'options' => [
                        'data' => ['' => 'Select ...'] + \common\models\c2\entity\Supplier::getHashMap('id', 'name', [
                                'status' => EntityModelStatus::STATUS_ACTIVE,
                            ]),
                    ]
                ],
