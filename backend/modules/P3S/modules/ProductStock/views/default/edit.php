...
use backend\modules\P3S\modules\ProductStock\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\ProductStock */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Product Stock'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Product Stocks'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Product Stock'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Product Stocks'), 'url' => ['index']];
