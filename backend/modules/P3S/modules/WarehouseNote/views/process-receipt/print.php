...
<div style="background-color: #f3c17d; margin-bottom: 10px">
    ...
    <table class="table table-bordered mt10">
        ...
        <tr class="tc">
            ...
            <td class="box120">发出数量</td>
            <td class="box120">进仓物料</td>
            <td class="box120">进仓数量</td>
            <td class="memo">备注</td>
        </tr>

        <?php foreach ($model->getScheduleItems()->with('enterProduct')->all() as $item): ?>
            <tr class="tc">
                ...
                <td class=""><?= $item->enterProduct->name . '(' . $item->enterProduct->name . ')' . $item->enterProduct->name ?></td>
