...
">
    ...
    <div class="well">
        ...
        ?>
        <p style="color: red;">细项小计不填则自动计算</p>
        <?php
                    ...
                    'options' => [
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'type' => \kartik\select2\Select2::className(),
                                'options' => [
                                    'data' => ['' => 'selecting...'] + \common\models\c2\entity\InventoryReceiptNoteItem::getHashMap('id', 'product_name', [
                                            'note_id' => $model->ref_note_id,
                                        ]),
                                    'pluginEvents' => [
                                        'change' => "function() {
                                                $.post('" . Url::toRoute(['note-item']) . "', {'depdrop_all_params[id]':$(this).val(),'depdrop_parents[]':$(this).val()}, function(data) {
                                                    if(data.output !== undefined) {
                                                        $('#product-{multiple_index_{$multipleItemsId}}').val(data.output.product_id);
                                                        $('#price-{multiple_index_{$multipleItemsId}}').val(data.output.price);
                                                        $('#subtotal-{multiple_index_{$multipleItemsId}}').val(data.output.subtotal);
                                                        $('#number-{multiple_index_{$multipleItemsId}}').val(data.output.number);
                                                    }
                                                })
                                            }",
                                    ],
                            ...
                            [
                                'name' => 'product_id',
                                'title' => Yii::t('app.c2', 'PRODUCT ID'),
                                'enableError' => true,
                                'options' => [
                                    'readonly' => true,
                                    'id' => "product-{multiple_index_{$multipleItemsId}}",
                                ]
                            ],
                            [
                                'name' => 'measure_id',
                            ...
                            [
                                'name' => 'number',
                                'title' => Yii::t('app.c2', 'Commit Warehouse Number'),
                                'enableError' => true,
                                'defaultValue' => 0,
                                'options' => [
                                    'id' => "number-{multiple_index_{$multipleItemsId}}",
                                    'type' => 'number',
                                    'min' => 0,
                                    'step' => 'any',
                                ]
                            ...
                            [
                                'name' => 'price',
                                'title' => Yii::t('app.c2', 'Associate Receipt Price'),
                                'enableError' => true,
                                'defaultValue' => '0.000',
                                'options' => [
                            ...
                            [
                                'name' => 'subtotal',
                                'title' => Yii::t('app.c2', 'Associate Receipt Subtotal'),
                                'enableError' => true,
                                'defaultValue' => '0.0000',
                                'options' => [
