...
class ReceiptController extends Controller
{
    ...
    public function actions()
    {
        return ArrayHelper::merge(parent::actions(), [
            'note-item' => [
                'class' => 'common\components\actions\ReceiptNoteItemOptionsAction',
            ],
        ]);
    }
    ...
    public function actionIndex($id = null)
    {
        ...
        $searchModel->type = WarehouseNoteType::RECEIPT;
        $searchModel->ref_note_id = $id;
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        $note = InventoryReceiptNote::findOne($id);
    ...
    public function actionEdit($id = null, $ref_note_id = null)
    {
        ...
        $model->type = WarehouseNoteType::RECEIPT;
        $model->ref_note_id = $ref_note_id;
        $node = InventoryReceiptNote::findOne($ref_note_id);
    ...
    public function actionCommit($id)
    {
        try {
            $model = $this->retrieveModel($id);
            if ($model) {
                $model->setReceiptNoteStateToCommit();
