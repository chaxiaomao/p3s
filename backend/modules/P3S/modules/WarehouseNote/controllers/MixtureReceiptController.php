 ...
 */
class MixtureReceiptController extends Controller
{
    ...
    public function actionIndex($id = null)
    {
        ...
        $searchModel->type = WarehouseNoteType::MIXTURE_RECEIPT;
    ...
    public function actionEdit($id = null, $ref_note_id = null)
    {
        ...
        $model->type = WarehouseNoteType::MIXTURE_RECEIPT;
    ...
    public function actionCommit($id)
    {
        try {
            $model = $this->retrieveModel($id);
            if ($model) {
                $model->setReceiptMaterialToCommit1();
