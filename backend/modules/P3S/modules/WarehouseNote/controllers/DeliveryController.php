...
class DeliveryController extends Controller
{
    ...
    public function actionIndex($id = null)
    {
        ...
        $searchModel->type = WarehouseNoteType::DELIVERY;
        $searchModel->ref_note_id = $id;
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        $note = InventoryDeliveryNote::findOne($id);
    ...
    public function actionLog($id = null)
    {
        $searchModel = new WarehouseNoteSearch();
        $searchModel->type = WarehouseNoteType::DELIVERY;
        $searchModel->state = WarehouseNoteState::COMMIT;
        $searchModel->ref_note_id = $id;
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
    ...
    public function actionEdit($id = null, $ref_note_id = null)
    {
        ...
        $model->type = WarehouseNoteType::DELIVERY;
        $model->ref_note_id = $ref_note_id;
        $node = InventoryDeliveryNote::findOne($ref_note_id);
    ...
    {
        try {
            $model = InventoryDeliveryNote::findOne($id);
            if ($model) {
                $model->allSend();
                $responseData = ResponseDatum::getSuccessDatum(['message' => Yii::t('cza', 'Operation completed successfully!')], $id);
            } else {
