...
use backend\modules\P3S\modules\Warehouse\modules\CommitNote\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\WarehouseCommitNote */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Warehouse Commit Note'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouse Commit Notes'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Warehouse Commit Note'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouse Commit Notes'), 'url' => ['index']];
