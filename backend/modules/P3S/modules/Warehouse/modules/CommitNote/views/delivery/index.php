...
?>
    ...
    <div class="well warehouse-commit-note-index">
        ...
        <div style="background-color: #d0e9c6;margin-bottom: 20px;">
            <?php echo $this->render('print', ['model' => $deliveryNote]) ?>
        </div>
        ...
        <?php echo GridView::widget([
            ...
            'toolbar' => [
                [
                    'content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['edit', 'note_id' => $deliveryNote->id], [
        ...
        echo Html::a('<i class="fa fa-arrow-left"></i> ' . Yii::t('app.c2', 'Go Back'), ['/p3s/processing/delivery-note'], ['data-pjax' => '0', 'class' => 'btn btn-default pull-right', 'title' => Yii::t('app.c2', 'Go Back'),]);
