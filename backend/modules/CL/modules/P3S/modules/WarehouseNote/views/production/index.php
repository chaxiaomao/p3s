            ...
            'toolbar' => [
                [
                    'content' =>
                        ...
                        Html::a('<i class="glyphicon glyphicon-adjust">' . Yii::t('app.c2', 'All Enter') . '</i>', [
                            'all-enter',
                            'id' => $note->id,
                        ], [
                            'class' => 'btn btn-danger all-enter',
                            'title' => Yii::t('app.c2', 'All Enter'),
                            'data-pjax' => '0',
                        ]) . '' .
...
$js .= "jQuery(document).off('click', 'a.all-enter').on('click', 'a.all-enter', function(e) {
                e.preventDefault();
                var lib = window['krajeeDialog'];
                var url = jQuery(e.currentTarget).attr('href');
                lib.confirm('" . Yii::t('app.c2', 'Are you sure? This action can not reverse.') . "', function (result) {
