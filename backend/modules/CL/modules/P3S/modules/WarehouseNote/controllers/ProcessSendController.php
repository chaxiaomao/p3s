 ...
 */
class ProcessSendController extends Controller
{
    ...
    public function actionIndex($id = null)
    {
        ...
        $searchModel->type = WarehouseNoteType::PROCESS_SAB;
    ...
    public function actionEdit($id = null, $ref_note_id = null)
    {
        ...
        $model->type = WarehouseNoteType::PROCESS_SAB;
    ...
    public function actionCommit($id)
    {
        try {
            $model = $this->retrieveModel($id);
            if ($model) {
                $model->setProcessSendNoteStateToCommit();
