    ...
    public function init()
    {
        ...
        $this->modules = [
            'order-item-consumption' => [
                'class' => 'backend\modules\CL\modules\P3S\modules\Order\modules\OrderItemConsumption\Module',
            ],
            'order-item' => [
                'class' => 'backend\modules\CL\modules\P3S\modules\Order\modules\OrderItem\\Module',
            ],
        ];
