            ...
            echo Form::widget([
                ...
                'attributes' => [
                    ...
                    'producer' => [
                        ...
                        'options' => ['placeholder' => $model->getAttributeLabel('producer')]
                    ],
                    ...
                    'items' => [
                        ...
                        'options' => [
                            ...
                            'columns' => [
                                ...
                                //     'name' => 'product_id',
                                //     // 'type' => 'dropDownList',
                                //     'title' => Yii::t('app.c2', 'Process Product'),
                                //     'enableError' => true,
                                ...
                                //     'options' => [
                                //         'data' => \backend\models\c2\entity\Material::getMixedOptions('id', 'name', [
                                ...
                                [
                                    'name' => 'production_sum',
                                    'title' => Yii::t('app.c2', 'Process Sum'),
                                    'enableError' => true,
                                    'options' => [
                                        'type' => 'number',
                                        'min' => 0,
                                ...
                                [
                                    ...
                                    // 'type' => 'dropDownList',
                                    'title' => Yii::t('app.c2', 'Finish Product'),
                                    'enableError' => true,
                                    // 'items' => ['' => Yii::t("app.c2", "Select options ..")] + \common\models\c2\entity\ProductModel::getHashMap('id', 'sku', ['status' => EntityModelStatus::STATUS_ACTIVE]),
                                    'type' => \kartik\select2\Select2::className(),
                                    'options' => [
                                ...
                                [
                                    'name' => 'enter_sum',
                                    'title' => Yii::t('app.c2', 'Enter Finish Sum'),
                                    'enableError' => true,
                                    'options' => [
                                        'type' => 'number',
                                        'min' => 0,
